...
$(document).ready(function() {
    ...
    ;
    var minimums =   
        <?php echo json_encode($dminimums, JSON_NUMERIC_CHECK); ?>
        ;
        var maximums =   
            <?php echo json_encode($dmaximums, JSON_NUMERIC_CHECK); ?>
            ;
            var summary_tag =  '
...
$('.switcher').click(function () {
    ...
    if (id == 'Daily') {
        var averages =  
            <?php echo json_encode($daverages, JSON_NUMERIC_CHECK); ?>
            ;
            var minimums =   
                <?php echo json_encode($dminimums, JSON_NUMERIC_CHECK); ?>
                ;
        ...
        ;
        var minimums =   
            <?php echo json_encode($wminimums, JSON_NUMERIC_CHECK); ?>
            ;
            var maximums =   
                <?php echo json_encode($wmaximums, JSON_NUMERIC_CHECK); ?>;
        ...
        ;
        var minimums =   
            <?php echo json_encode($mminimums, JSON_NUMERIC_CHECK); ?>
            ;
            var maximums =   
                <?php echo json_encode($mmaximums, JSON_NUMERIC_CHECK); ?>
                ;
